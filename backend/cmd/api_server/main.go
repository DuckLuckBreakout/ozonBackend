...
import (
	...
	admin_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/admin/handler"
	admin_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/admin/usecase"
	cart_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/cart/handler"
	cart_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/cart/usecase"
	category_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/category/handler"
	category_repo "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/category/repository"
	category_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/category/usecase"
	csrf_token_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/csrf_token/handler"
	favorites_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/favorites/handler"
	favorites_repo "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/favorites/repository"
	favorites_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/favorites/usecase"
	notification_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/notification/handler"
	notification_repo "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/notification/repository"
	notification_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/notification/usecase"
	order_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/order/handler"
	order_repo "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/order/repository"
	order_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/order/usecase"
	product_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/product/handler"
	product_repo "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/product/repository"
	product_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/product/usecase"
	promo_code_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/promo_code/handler"
	promo_code_repo "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/promo_code/repository"
	promo_code_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/promo_code/usecase"
	review_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/review/handler"
	review_repo "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/review/repository"
	review_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/review/usecase"
	session_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/session/handler"
	session_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/session/usecase"
	user_delivery "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/user/handler"
	user_repo "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/user/repository"
	user_usecase "github.com/DuckLuckBreakout/ozonBackend/internal/pkg/user/usecase"
	"github.com/DuckLuckBreakout/ozonBackend/internal/server/errors"
	"github.com/DuckLuckBreakout/ozonBackend/internal/server/middleware"
	"github.com/DuckLuckBreakout/ozonBackend/internal/server/tools/s3_utils"
	_ "github.com/DuckLuckBreakout/ozonBackend/internal/server/tools/s3_utils"
	"github.com/DuckLuckBreakout/ozonBackend/pkg/metrics"
	"github.com/DuckLuckBreakout/ozonBackend/pkg/tools/logger"
	_ "github.com/DuckLuckBreakout/ozonBackend/pkg/tools/server_push"
	...
	session_service "github.com/DuckLuckBreakout/ozonBackend/services/session/proto/session"
